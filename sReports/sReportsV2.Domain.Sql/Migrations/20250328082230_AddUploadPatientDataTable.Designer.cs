...
namespace sReportsV2.Domain.Sql.Migrations
{
    ...
    [Migration("20250328082230_AddUploadPatientDataTable")]
    partial class AddUploadPatientDataTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.Patient.PatientChemotherapyData", b =>
                {
                    b.Property<int>("PatientChemotherapyDataId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PatientChemotherapyDataId"));
                    ...
                    b.Property<int?>("ContraceptionCD")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DiseaseContextAtCurrentPresentationCD")
                        .HasColumnType("int");

                    b.Property<int?>("DiseaseContextAtInitialPresentationCD")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PatientChemotherapyDataId");

                    b.HasIndex("ContraceptionCD");

                    b.HasIndex("CreatedById");

                    b.HasIndex("DiseaseContextAtCurrentPresentationCD");

                    b.HasIndex("DiseaseContextAtInitialPresentationCD");
                    ...
                    b.ToTable("PatientChemotherapyDatas");
                });
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.PatientList.PatientList", b =>
                {
                    ...
                    b.Property<bool>("ExcludeDeceasedPatient")
                        .HasColumnType("bit");

                    b.Property<bool>("IncludeDischargedPatient")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ShowOnlyDischargedPatient")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.ThesaurusEntry.FormThesaurusReportView", b =>
                {
                    ...
                    b.ToTable("FormThesaurusReportViews");
                });
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.ThesaurusEntry.ThesaurusEntryView", b =>
                {
                    b.Property<int>("ThesaurusEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.UploadPatientData", b =>
                {
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.ChemotherapySchemaInstance.ChemotherapySchemaInstance", b =>
                {
                    ...
                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "InstanceState")
                        .WithMany()
                        .HasForeignKey("StateCD");
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.ChemotherapySchemaInstance.ChemotherapySchemaInstanceVersion", b =>
                {
                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "ChemotherapySchemaInstanceActionType")
                        .WithMany()
                        .HasForeignKey("ActionTypeCD");
                    ...
                    b.Navigation("ChemotherapySchemaInstanceActionType");
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.FormComment.Comment", b =>
                {
                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "CommentStateCode")
                        .WithMany()
                        .HasForeignKey("CommentStateCD");
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.GlobalThesaurusUser.GlobalThesaurusUser", b =>
                {
                    ...
                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "SourceCode")
                        .WithMany()
                        .HasForeignKey("SourceCD");

                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "StatusCode")
                        .WithMany()
                        .HasForeignKey("StatusCD");
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.Patient.PatientChemotherapyData", b =>
                {
                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "ContraceptionCode")
                        .WithMany()
                        .HasForeignKey("ContraceptionCD");

                    b.HasOne("sReportsV2.Domain.Sql.Entities.User.Personnel", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "DiseaseContextCurrentPresentation")
                        .WithMany()
                        .HasForeignKey("DiseaseContextAtCurrentPresentationCD");

                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "DiseaseContextInitialPresentation")
                        .WithMany()
                        .HasForeignKey("DiseaseContextAtInitialPresentationCD");
                    ...
                    b.HasOne("sReportsV2.Domain.Sql.Entities.Patient.Patient", null)
                        .WithOne("PatientChemotherapyData")
                        .HasForeignKey("sReportsV2.Domain.Sql.Entities.Patient.PatientChemotherapyData", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ContraceptionCode");

                    b.Navigation("CreatedBy");

                    b.Navigation("DiseaseContextCurrentPresentation");

                    b.Navigation("DiseaseContextInitialPresentation");
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.ThesaurusEntry.ThesaurusEntry", b =>
                {
                    ...
                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "StateCode")
                        .WithMany()
                        .HasForeignKey("StateCD")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.ThesaurusEntry.Version", b =>
                {
                    ...
                    b.HasOne("sReportsV2.Domain.Sql.Entities.Common.Code", "TypeCode")
                        .WithMany()
                        .HasForeignKey("TypeCD");
            ...
            modelBuilder.Entity("sReportsV2.Domain.Sql.Entities.Patient.Patient", b =>
                {
                    ...
                    b.Navigation("PatientChemotherapyData");
