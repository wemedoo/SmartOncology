    ...
    public abstract class ExcelImporter
    {
        ...
        protected Cell GetLastCellInColumn(string columnCellAddress, string schemaName)
        {
            return sheetData.Descendants<Row>()
                            .SelectMany(r => r.Descendants<Cell>())
                            .Last(c => GetColumnName(c.CellReference) == GetColumnName(columnCellAddress) && GetText(c) == schemaName);
        }
        ...
        protected Cell GetLastCellInColumn(string columnCellAddress)
        {
            return sheetData.Descendants<Row>()
                            .SelectMany(r => r.Descendants<Cell>())
                            .Last(c => GetColumnName(c.CellReference) == GetColumnName(columnCellAddress));
        }
        ...
        {
            return schemaHeaderCells.Find(c => c.Name == columnName).Address;
        }
