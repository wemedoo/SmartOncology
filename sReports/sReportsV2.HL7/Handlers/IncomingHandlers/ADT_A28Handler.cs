...
{
    public class ADT_A28Handler : HL7IncomingMessageHandler
    {
        public ADT_A28Handler(IncomingMessageMetadataDTO messageMetadata) : base(messageMetadata)
        {
        }
        public override async Task Process(SReportsContext dbContext)
        {
            ...
            await CommitTransaction(dbContext, patientDAL, patientDB, procedeedEncounter: null);
        }
    }
}