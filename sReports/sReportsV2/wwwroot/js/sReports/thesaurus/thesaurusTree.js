function loadThesaurusTree() {
    callServer({
        type: 'GET',
        data: getThesaurusFilterObject(false),
...
function getThesaurusFilterObject(includeSearchTerm = true) {
    let requestObject = {
        o4MtId: $('#Id').val(),
        thesaurusPageNum: thesaurusPageNum
    };
    if (includeSearchTerm) {
        requestObject.searchTerm = $('#quickSearch').val();
    }
