...
namespace sReportsV2.Domain.Services.Implementations
{
    public class CustomFieldFilterDAL : ICustomFieldFilterDAL
    {
        ...
        public CustomFieldFilterDAL()
        {
            ...
            Collection = MongoDatabase.GetCollection<CustomFieldFilterGroup>(MongoCollectionNames.CustomFieldFilter);
        }
        ...
        public string InsertOrUpdateCustomFieldFilter(CustomFieldFilterGroup customFieldFilterGroup)
        {
            ...
            {
                Collection.AsQueryable().FirstOrDefault(x => x.Id.Equals(customFieldFilterGroup.Id));
                ...
                _ = Collection.ReplaceOne(filter, customFieldFilterGroup).ModifiedCount;
            }
