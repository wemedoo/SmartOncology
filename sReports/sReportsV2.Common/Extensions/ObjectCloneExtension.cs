...
namespace sReportsV2.Common.Extensions
{
    ...
    public class FormFileClone : FormFile
    {
        public FormFileClone(IFormFile originalFile) : base(null, 0, originalFile.Length, originalFile.Name, originalFile.FileName)
        {
            this.Headers = originalFile.Headers;
        }
